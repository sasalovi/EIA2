namespace abschluss2 {
    ...
    var maxMun: number = 6;
    var municolor: string = "hsl(" + Math.random() * 360 + ", 100%, 50%)";
    ...
    function shooter(): void {
        ...
        for (let i: number = 0; i < maxMun; i++) {
            ...
            let s: Munition = new Munition(xOffset, 0); //Instanz der Klasse wird erstellt
            muni.push(s);
            s.draw();
            xOffset = xOffset + 50;
        }
        ...
        image = crc2.getImageData(0, 0, 1280, 900); //Bild speichern
    ...
    function animate(): void {
        crc2.clearRect(0, 0, 1280, 900); // hier Hintergrund restaurieren
